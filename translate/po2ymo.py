...
def po2ymohpp(lang, includefuzzy=False, encoding='utf-8', byteorder='little'):
    ...
    with open(Path(__file__).parent.parent / f"src/I18n/i18n_ymo_{lang}.hpp", "w", newline="") as wf:
        wf.write("#pragma once\n")
        wf.write(f"// Autogenerated file from {lang}.ymo\n")
        wf.write("static const unsigned char i18n_ymo_%s[] = {\n\t" % lang)
        contents = f.getvalue()
        perline = 10
